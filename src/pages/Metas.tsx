    ...
    <div className="flex-1 flex flex-col h-full overflow-hidden relative">
      ...
      {isModalOpen && selectedCategory && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm transition-opacity duration-300">
          <div className="w-full max-w-sm bg-white border border-[#E8E8EE] rounded-[14px] shadow-2xl p-4 sm:p-6 transform scale-100 transition-all duration-300 animate-in fade-in zoom-in-95">
